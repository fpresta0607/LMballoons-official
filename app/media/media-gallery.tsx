...
// Desktop (3-col): mixed spans for visual interest. Indexed with modulo so any
// number of photos reflows cleanly — no per-image positioning needed.
const desktopBento = [
...
// Mobile (2-col): uniform 1x1 grid — every 5th item spans full width for variety.
